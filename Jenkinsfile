 ...
 stage('Install Dependencies') {
    ...
    stage('Docker Build and Push') {
      steps {
          ...
          sh 'docker build -t jp38919/food-delivery-app-fe:${VERSION} .'
          sh 'docker push jp38919/food-delivery-app-fe:${VERSION}'
      }
    }
     ...
     stage('Update Image Tag in GitOps') {
      steps {
       ...
       sh '''
          sed -i "s/image:.*/image: jp38919\\/food-delivery-app-fe:${VERSION}/" aws/angular-manifest.yml
        '''
